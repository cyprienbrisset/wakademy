  ...
  return (
    ...
    >
      <div className="relative aspect-video">
        ...
        >
          <p className="text-white text-sm mb-4 overflow-hidden text-ellipsis" style={{
            height: '3.6em',
            lineHeight: '1.2em'
          }}>{safeContent.description && safeContent.description.length > 100 ? safeContent.description.substring(0, 100) + '...' : safeContent.description}</p>
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button size="icon" variant="secondary" className="h-8 w-8 ml-auto" onClick={shareContent}>
      ...
      <CardContent className="p-4">
        ...
        <h3 className="font-medium overflow-hidden text-ellipsis" style={{
          height: '2.4em',
          lineHeight: '1.2em'
        }}>{safeContent.title && safeContent.title.length > 50 ? safeContent.title.substring(0, 50) + '...' : safeContent.title}</h3>
